...
\normalfont{\textbf{Обязанности}: Имплементировал механизм рекалькуляции (вычисление средней себестоимости в момент времени) в CRM для клиента "Zebra Coffee", а также функционал поставок, перемещений и списаний. \\ \textbf{Технологии}: Django, DRF, Docker, Git }
